...
COPYDEST := C:/daintree
CSRCS := entry.c interrupts.c console.c mem.c arch.c string.c ctype.c stdlib.c program.c ast.c crc32.c dict.c math.c task.c console_task.c manager_task.c gc.c
